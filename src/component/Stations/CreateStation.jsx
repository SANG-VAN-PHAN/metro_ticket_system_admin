...
const CreateStation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Chỉ check tên ga là bắt buộc
    if (!form.name.trim()) {
      setError('Vui lòng nhập tên ga!');
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errorText || 'Lỗi khi tạo nhà ga!');
      }
      ...
      setError(err.message || 'Không thể tạo nhà ga. Vui lòng thử lại!');
    } finally {
      setLoading(false);
    }
  };
